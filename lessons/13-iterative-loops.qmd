...
- 📓 **[Open in JupyterLite](../jupyterlite/lab/index.html?path=13-iterative-loops.ipynb)** - Full Jupyter environment in your browser
- ▶️ **Run code directly below** - All code cells on this page are editable and runnable
- 📥 **[Download Notebook](../jupyterlite/content/13-iterative-loops.ipynb)** - For use in local Jupyter or Google Colab
:::
